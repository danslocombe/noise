...
pub fn does_collide (p : &BBProperties, bb : &BoundingBox, bbs : &[BBDescriptor], 
...
pub fn does_collide_bool(p : &BBProperties, bb : &BoundingBox, bbs : &[BBDescriptor], to_collide : BBOwnerType,
